    ...
    return {
        link: function(scope, element) {
            var listener = function(event, toState, toParams, fromState, fromParams) {
                ...
                var title = 'HUNGRY | Responsive Admin Theme';
                // Create your own title pattern
                if (toState.data && toState.data.pageTitle) title = 'HUNGRY | ' + toState.data.pageTitle;
                $timeout(function() {
                    element.text(title);
                });
            };
...
angular
    .module('HUNGRY').directive('fileUpload', function () {
    return {
