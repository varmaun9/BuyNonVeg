...
@Component("offerExcludeConfigRepresentation")
@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
@Siren4JEntity(name = "offerExcludeConfig", uri = "/offerExcludeConfigs/{id}")
@Representation(OfferExcludeConfigModel.class)
public class OfferExcludeConfigRepresentation extends BaseResource {
