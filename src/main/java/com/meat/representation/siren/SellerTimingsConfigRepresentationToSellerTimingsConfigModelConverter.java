 ...
 *
 */
@Component("sellerTimingsConfigRepresentationToSellerTimingsConfigModelConverter")
public class SellerTimingsConfigRepresentationToSellerTimingsConfigModelConverter extends
